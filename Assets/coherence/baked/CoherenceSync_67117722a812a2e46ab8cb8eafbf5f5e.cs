...
namespace Coherence.Generated
{
    ...
    public class Binding_67117722a812a2e46ab8cb8eafbf5f5e_6f3def5e14144ea4b3cd4582b0cc0b69 : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_67117722a812a2e46ab8cb8eafbf5f5e : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_67117722a812a2e46ab8cb8eafbf5f5e>();
        ...
        {
			["6f3def5e14144ea4b3cd4582b0cc0b69"] = new Binding_67117722a812a2e46ab8cb8eafbf5f5e_6f3def5e14144ea4b3cd4582b0cc0b69(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_67117722a812a2e46ab8cb8eafbf5f5e()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_67117722a812a2e46ab8cb8eafbf5f5e Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_67117722a812a2e46ab8cb8eafbf5f5e>();
            this.bridge = bridge;
