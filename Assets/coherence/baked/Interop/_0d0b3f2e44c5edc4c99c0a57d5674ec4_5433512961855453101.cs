...
namespace Coherence.Generated
{
    ...
    public struct _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101.SyncedProxyPositionMask;
            SyncedProxyPositionSimulationFrame = frame;
            FieldsMask |= _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101.SyncedProxyRotationMask;
            SyncedProxyRotationSimulationFrame = frame;
            FieldsMask |= _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101.VelocityMask;
            VelocitySimulationFrame = frame;
            FieldsMask |= _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101.AngularVelocityMask;
            AngularVelocitySimulationFrame = frame;
            FieldsMask |= _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101.IsLandedMask;
            IsLandedSimulationFrame = frame;
            FieldsMask |= _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101.enabledMask;
            enabledSimulationFrame = frame;
        }

        public static unsafe _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 54) {
            ...
            var orig = new _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101();
        ...
        {
            var other = (_0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101)data;
        ...
        public static uint Serialize(_0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101();
            if (bitStream.ReadMask())
            {

                val.SyncedProxyPosition = bitStream.ReadVector3(FloatMeta.NoCompression()).ToUnityVector3();
                val.FieldsMask |= _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101.SyncedProxyPositionMask;
            }
            if (bitStream.ReadMask())
            {

                val.SyncedProxyRotation = bitStream.ReadQuaternion(32).ToUnityQuaternion();
                val.FieldsMask |= _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101.SyncedProxyRotationMask;
            }
            if (bitStream.ReadMask())
            {

                val.Velocity = bitStream.ReadVector3(FloatMeta.NoCompression()).ToUnityVector3();
                val.FieldsMask |= _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101.VelocityMask;
            }
            if (bitStream.ReadMask())
            {

                val.AngularVelocity = bitStream.ReadVector3(FloatMeta.NoCompression()).ToUnityVector3();
                val.FieldsMask |= _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101.AngularVelocityMask;
            }
            if (bitStream.ReadMask())
            {

                val.IsLanded = bitStream.ReadBool();
                val.FieldsMask |= _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101.IsLandedMask;
            }
            if (bitStream.ReadMask())
            {

                val.enabled = bitStream.ReadBool();
                val.FieldsMask |= _0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101.enabledMask;
            }
        ...
        {
            return $"_0d0b3f2e44c5edc4c99c0a57d5674ec4_5433512961855453101(" +
