...
namespace Coherence.Generated
{
    ...
    public struct _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203.SyncedProxyPositionMask;
            SyncedProxyPositionSimulationFrame = frame;
            FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203.SyncedProxyRotationMask;
            SyncedProxyRotationSimulationFrame = frame;
            FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203.VelocityMask;
            VelocitySimulationFrame = frame;
            FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203.AngularVelocityMask;
            AngularVelocitySimulationFrame = frame;
            FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203.IsLandedMask;
            IsLandedSimulationFrame = frame;
            FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203.enabledMask;
            enabledSimulationFrame = frame;
        }

        public static unsafe _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 54) {
            ...
            var orig = new _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203();
        ...
        {
            var other = (_0f1baba4f59f64140a0ff46868bde78f_7808355085924611203)data;
        ...
        public static uint Serialize(_0f1baba4f59f64140a0ff46868bde78f_7808355085924611203 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203();
            if (bitStream.ReadMask())
            {

                val.SyncedProxyPosition = bitStream.ReadVector3(FloatMeta.NoCompression()).ToUnityVector3();
                val.FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203.SyncedProxyPositionMask;
            }
            if (bitStream.ReadMask())
            {

                val.SyncedProxyRotation = bitStream.ReadQuaternion(32).ToUnityQuaternion();
                val.FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203.SyncedProxyRotationMask;
            }
            if (bitStream.ReadMask())
            {

                val.Velocity = bitStream.ReadVector3(FloatMeta.NoCompression()).ToUnityVector3();
                val.FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203.VelocityMask;
            }
            if (bitStream.ReadMask())
            {

                val.AngularVelocity = bitStream.ReadVector3(FloatMeta.NoCompression()).ToUnityVector3();
                val.FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203.AngularVelocityMask;
            }
            if (bitStream.ReadMask())
            {

                val.IsLanded = bitStream.ReadBool();
                val.FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203.IsLandedMask;
            }
            if (bitStream.ReadMask())
            {

                val.enabled = bitStream.ReadBool();
                val.FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_7808355085924611203.enabledMask;
            }
        ...
        {
            return $"_0f1baba4f59f64140a0ff46868bde78f_7808355085924611203(" +
