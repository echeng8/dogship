...
namespace Coherence.Generated
{
    ...
    public struct _0f1baba4f59f64140a0ff46868bde78f_8597659800900311073 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_8597659800900311073.networkedCurrentFieldTransformMask;
            networkedCurrentFieldTransformSimulationFrame = frame;
        }

        public static unsafe _0f1baba4f59f64140a0ff46868bde78f_8597659800900311073 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
            ...
            var orig = new _0f1baba4f59f64140a0ff46868bde78f_8597659800900311073();
        ...
        {
            var other = (_0f1baba4f59f64140a0ff46868bde78f_8597659800900311073)data;
        ...
        public static uint Serialize(_0f1baba4f59f64140a0ff46868bde78f_8597659800900311073 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _0f1baba4f59f64140a0ff46868bde78f_8597659800900311073 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _0f1baba4f59f64140a0ff46868bde78f_8597659800900311073();
            if (bitStream.ReadMask())
            {

                val.networkedCurrentFieldTransform = bitStream.ReadEntity();
                val.FieldsMask |= _0f1baba4f59f64140a0ff46868bde78f_8597659800900311073.networkedCurrentFieldTransformMask;
            }
        ...
        {
            return $"_0f1baba4f59f64140a0ff46868bde78f_8597659800900311073(" +
