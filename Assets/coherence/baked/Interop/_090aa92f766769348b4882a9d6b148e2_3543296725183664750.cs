...
namespace Coherence.Generated
{
    ...
    public struct _090aa92f766769348b4882a9d6b148e2_3543296725183664750 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _090aa92f766769348b4882a9d6b148e2_3543296725183664750.networkedCurrentFieldTransformMask;
            networkedCurrentFieldTransformSimulationFrame = frame;
        }

        public static unsafe _090aa92f766769348b4882a9d6b148e2_3543296725183664750 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
            ...
            var orig = new _090aa92f766769348b4882a9d6b148e2_3543296725183664750();
        ...
        {
            var other = (_090aa92f766769348b4882a9d6b148e2_3543296725183664750)data;
        ...
        public static uint Serialize(_090aa92f766769348b4882a9d6b148e2_3543296725183664750 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _090aa92f766769348b4882a9d6b148e2_3543296725183664750 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _090aa92f766769348b4882a9d6b148e2_3543296725183664750();
            if (bitStream.ReadMask())
            {

                val.networkedCurrentFieldTransform = bitStream.ReadEntity();
                val.FieldsMask |= _090aa92f766769348b4882a9d6b148e2_3543296725183664750.networkedCurrentFieldTransformMask;
            }
        ...
        {
            return $"_090aa92f766769348b4882a9d6b148e2_3543296725183664750(" +
