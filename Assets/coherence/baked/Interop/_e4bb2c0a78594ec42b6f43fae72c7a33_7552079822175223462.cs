...
namespace Coherence.Generated
{
    ...
    public struct _e4bb2c0a78594ec42b6f43fae72c7a33_7552079822175223462 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _e4bb2c0a78594ec42b6f43fae72c7a33_7552079822175223462.SyncedProxyPositionMask;
            SyncedProxyPositionSimulationFrame = frame;
            FieldsMask |= _e4bb2c0a78594ec42b6f43fae72c7a33_7552079822175223462.SyncedProxyRotationMask;
            SyncedProxyRotationSimulationFrame = frame;
        }

        public static unsafe _e4bb2c0a78594ec42b6f43fae72c7a33_7552079822175223462 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 28) {
            ...
            var orig = new _e4bb2c0a78594ec42b6f43fae72c7a33_7552079822175223462();
        ...
        {
            var other = (_e4bb2c0a78594ec42b6f43fae72c7a33_7552079822175223462)data;
        ...
        public static uint Serialize(_e4bb2c0a78594ec42b6f43fae72c7a33_7552079822175223462 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _e4bb2c0a78594ec42b6f43fae72c7a33_7552079822175223462 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _e4bb2c0a78594ec42b6f43fae72c7a33_7552079822175223462();
            if (bitStream.ReadMask())
            {

                val.SyncedProxyPosition = bitStream.ReadVector3(FloatMeta.NoCompression()).ToUnityVector3();
                val.FieldsMask |= _e4bb2c0a78594ec42b6f43fae72c7a33_7552079822175223462.SyncedProxyPositionMask;
            }
            if (bitStream.ReadMask())
            {

                val.SyncedProxyRotation = bitStream.ReadQuaternion(32).ToUnityQuaternion();
                val.FieldsMask |= _e4bb2c0a78594ec42b6f43fae72c7a33_7552079822175223462.SyncedProxyRotationMask;
            }
        ...
        {
            return $"_e4bb2c0a78594ec42b6f43fae72c7a33_7552079822175223462(" +
